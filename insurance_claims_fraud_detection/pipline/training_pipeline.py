...
from insurance_claims_fraud_detection.entity.config_entity import DataIngestionConfig
from insurance_claims_fraud_detection.entity.artifact_entity import DataIngestionArtifact
